        ...
        <div class="page-header">
            <h1>
                ...
                <small>
                    ...
                    <?php
                    if (is_null($client->firstname) && is_null($client->lastname)) {
                        if (is_null($client->nickname)) {
                            echo "$client->company";
                        } else {
                                ...
                                <div id="home" class="tab-pane in active">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <h4 class="blue">
                                                <span class="middle"><?php echo "$client->firstname $client->middlename $client->lastname"; ?></span>
                                            ...
                                            <div class="profile-user-info">
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span><?php echo $client->nickname; ?></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span><?php echo "$client->birthdate (Age: 21)"; ?></span>
                                                    </div>
                                                </div>
