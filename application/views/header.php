                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="<?php echo base_url(); ?>assets/avatars/<?php echo $image; ?>" alt="<?php echo $name; ?>'s Photo" />
            ...
            <div class="main-container-inner">
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <ul class="nav nav-list">
                        ...
                        <li <?php if ($this->uri->segment(1) == "inventory") echo ' class="active"' ?> >
                        ...
                        <li <?php if ($this->uri->segment(1) == "price") echo ' class="active"' ?> >
